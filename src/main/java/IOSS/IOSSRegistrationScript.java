...
public class IOSSRegistrationScript {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        String GGIDValue = "36 30 50 29 26 65"; // Replace with the GGId of the account you're using
        String VRNValue = "904526821"; // Use the same VRN used in previous script
        String bpId = "100379656";  // bpID for the account created linked to vrn
