...
public class OSSMakeNilReturnScript {
    ...
    public String executeSeleniumScript(boolean demo, boolean takeScreenShot, String govGatewayID) throws IOException, InterruptedException {
        ...
        if (takeScreenShot){
            ...
            try {
                FileHandler.copy(screenshotFile, new File("evidence/screenshots/OSS/Returns/OSSNilReturn_"+govGatewayID+"_"+formattedReturnReference+".png"));
                result += "Screenshot Saved to: " + "evidence/screenshots/OSS/Returns/OSSNilReturn_"+govGatewayID+"_"+formattedReturnReference+".png"+'\n';
            } catch (IOException e) {
