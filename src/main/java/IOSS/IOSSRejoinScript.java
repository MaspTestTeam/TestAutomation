...
// ******************************************************************
public class IOSSRejoinScript {
    public static void main(String[] args) throws IOException, InterruptedException {
        IOSSRejoinScript seleniumScript = new IOSSRejoinScript();
        //***************************************************************
        ...
        String result = seleniumScript.executeSeleniumScript(
                demoSelected, GGIDValue, vrn, iossId, stubLogin
        );
    ...
    public String executeSeleniumScript(
            boolean demo, String govGatewayID, String vrn, String iossId, boolean stubLogin
        ...
        //Do you want to cancel your request to leave the Import One Stop Shop scheme?
