...
// ******************************************************************
public class OSSSelfExcludeScript {
    public static void main(String[] args) throws IOException, InterruptedException {
        OSSSelfExcludeScript seleniumScript = new OSSSelfExcludeScript();
        //***************************************************************
    ...
    public String executeSeleniumScript(boolean demo, String govGatewayID, String reasonCode, String newCountry, String newCountryTaxCode
        ...
        if (Objects.equals(reasonCode, "6")) {
            ...
            utils.preventInputDuplication("value", newCountryTaxCode, driver);
            //Click continue
            driver.findElement(By.id("continue")).click();
