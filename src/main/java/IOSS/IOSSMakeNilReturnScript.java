...
public class IOSSMakeNilReturnScript {
    ...
    public String executeSeleniumScript(boolean demo, boolean takeScreenShot, String govGatewayID) throws IOException, InterruptedException {
        ...
        String accountDetailsCreated = govGatewayID + '\t' + returnReference + '\t' + "nil" + '\t' + '\t' + '\t' + createdAt + '\t' + "false" + '\t' + "none";
        ...
        if (takeScreenShot){
            ...
            try {
                FileHandler.copy(screenshotFile, new File("evidence/screenshots/IOSS/Returns/IOSSNilReturn_"+govGatewayID+"_"+formattedReturnReference+".png"));
                result += "Screenshot Saved to: " + "evidence/screenshots/IOSS/Returns/IOSSNilReturn_"+govGatewayID+"_"+formattedReturnReference+".png"+'\n';
            } catch (IOException e) {
