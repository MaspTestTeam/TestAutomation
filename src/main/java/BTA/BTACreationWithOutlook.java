...
public class BTACreationWithOutlook {
    public static void main(String[] args) throws IOException {
        ...
        String VRNValue = "888636063"; // Replace with your VRN value
        String BPValue = "100380781";   //Replace with your BP value
    ...
    public String executeSeleniumScript(String VRNValue, String BPValue, boolean demo) throws IOException {
        ...
        try {
            ...
            /* THIS IS INCASE OF EXTRA AUTHENTICATION NEEDED
            //Sign In
